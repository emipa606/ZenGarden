...
internal class JobDriver_SitAtScenicBench : JobDriver
{
    ...
    protected override IEnumerable<Toil> MakeNewToils()
    {
        ...
        // Set up the toil
        var joyJob = DefDatabase<JobDef>.GetNamed("ZEN_SitAtScenicBench");
        var sitAtBench = new Toil
        {
    ...
    private float AverageBeautyPerceptible(IntVec3 root, Map map)
    {
        ...
        var beautyCells = BeautyUtility.beautyRelevantCells;
        for (var i = 0; i < beautyCells.Count; i++)
        {
            ...
            var plant = beautyCells[i].GetPlant(Map);
